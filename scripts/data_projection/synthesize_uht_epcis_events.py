#!/usr/bin/env python3
"""Synthesize hybrid GS1/EPCIS + UHT events from normalized food records."""
...
from ontology_package_emitters import emit_uht_epcis
...
def main() -> None:
    ...
    payload = "\n".join(emit_uht_epcis(record) for record in records)
