...
const ParticipantsManager: React.FC = () => {
    ...
    const mockParticipants: Participant[] = [
      {
        ...
        public_key:
          "ed25519:ABC123DEF456GHI789JKL012MNO345PQR678STU901VWX234YZ567",
      ...
      },
      {
        ...
        public_key:
          "ed25519:DEF456GHI789JKL012MNO345PQR678STU901VWX234YZ567ABC123",
      ...
      },
      {
        ...
        public_key:
          "ed25519:GHI789JKL012MNO345PQR678STU901VWX234YZ567ABC123DEF456",
        permissions: ["read", "write"],
      ...
      },
      {
        ...
        public_key:
          "ed25519:JKL012MNO345PQR678STU901VWX234YZ567ABC123DEF456GHI789",
      ...
      },
      {
        ...
        public_key:
          "ed25519:MNO345PQR678STU901VWX234YZ567ABC123DEF456GHI789JKL012",
      ...
      },
      {
        ...
        public_key:
          "ed25519:PQR678STU901VWX234YZ567ABC123DEF456GHI789JKL012MNO345",
        permissions: ["read"],
      ...
      },
      {
        ...
        public_key:
          "ed25519:STU901VWX234YZ567ABC123DEF456GHI789JKL012MNO345PQR678",
  ...
  const applyFilters = useCallback(() => {
    ...
    if (filters.type !== "all") {
      filtered = filtered.filter(
        (participant) => participant.type === filters.type,
      );
    }
    ...
    if (filters.status !== "all") {
      filtered = filtered.filter(
        (participant) => participant.status === filters.status,
      );
    }
            ...
            <div className="flex gap-2">
              <select
                ...
                onChange={(e) =>
                  handleFilterChange(
                    "type",
                    e.target.value as ParticipantType | "all",
                  )
                }
                  ...
                  {allPermissions.map((permission) => (
                    <label key={permission} className="flex items-center">
                      <input
                        ...
                        onChange={(e) => {
                          if (e.target.checked) {
                            handleFilterChange("permissions", [
                              ...filters.permissions,
                              permission,
                            ]);
                          } else {
              ...
              >
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-300">
                    ...
                    <span>
                      Last active: {formatLastActive(participant.last_active)}
                    </span>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {allPermissions.map((permission) => (
                      <label key={permission} className="flex items-center">
                        <input
                          type="checkbox"
                          checked={newParticipant.permissions.includes(
                            permission,
                          )}
                          onChange={(e) => {
                            if (e.target.checked) {
              ...
              <div className="flex justify-end gap-2 mt-6">
                ...
                <Button
                  ...
                  disabled={
                    ...
                    newParticipant.permissions.length === 0
                  }
                >
                  Add Participant
                </Button>
