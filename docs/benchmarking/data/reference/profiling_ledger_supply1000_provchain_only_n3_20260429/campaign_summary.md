...
| Field | Value |
|---|---|
| Campaign ID | `20260429_profile_ledger_supply1000_provchain-only_n3_fix1` |
...
| Managed ProvChain runtime dir | `/home/cit/provchain-org/benchmark-toolkit/results/provchain-runtime/20260429_profile_ledger_supply1000_provchain-only_n3_fix1` |
...
|---|---|---|---|
| `epoch-001` | `20260429T021835Z` | `passed` | ok |
| `epoch-002` | `20260429T021923Z` | `passed` | ok |
| `epoch-003` | `20260429T022006Z` | `passed` | ok |
