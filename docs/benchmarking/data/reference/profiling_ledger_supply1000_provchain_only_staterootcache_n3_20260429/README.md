# Curated Benchmark Evidence: 20260429_profile_ledger_supply1000_provchain-only_staterootcache_n3

This directory is a compact publication-facing export of the benchmark campaign:

- Source campaign: `benchmark-toolkit/results/campaigns/20260429_profile_ledger_supply1000_provchain-only_staterootcache_n3`
- Export generated at: `2026-04-29T06:18:20Z`
...
batching and state-root cache optimization. It supports only the benchmark
family, workload, products, and dataset slice listed above. Do not use it as
primary cross-system paper comparison evidence or as evidence for other
benchmark families, products, or runtime paths without a separate campaign and
validity gate.
