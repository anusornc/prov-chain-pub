...
| Field | Value |
|---|---|
| Campaign ID | `20260429_profile_ledger_supply1000_provchain-only_flush100_n3` |
...
| Managed ProvChain runtime dir | `/home/cit/provchain-org/benchmark-toolkit/results/provchain-runtime/20260429_profile_ledger_supply1000_provchain-only_flush100_n3` |
...
|---|---|---|---|
| `epoch-001` | `20260429T023100Z` | `passed` | ok |
| `epoch-002` | `20260429T023144Z` | `passed` | ok |
| `epoch-003` | `20260429T023223Z` | `passed` | ok |
