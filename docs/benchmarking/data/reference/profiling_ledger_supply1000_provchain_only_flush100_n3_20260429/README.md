# Curated Benchmark Evidence: 20260429_profile_ledger_supply1000_provchain-only_flush100_n3

This directory is a compact publication-facing export of the benchmark campaign:

- Source campaign: `benchmark-toolkit/results/campaigns/20260429_profile_ledger_supply1000_provchain-only_flush100_n3`
- Export generated at: `2026-04-29T02:33:15Z`
...
This specific export is reference/profiling evidence for R002 after enabling
benchmark-scoped RDF snapshot flush batching. It supports ProvChain write-path
bottleneck analysis only and must not be used as a primary cross-system
comparison table.
