...
| Field | Value |
|---|---|
| Campaign ID | `20260429_profile_ledger_supply1000_provchain-only_walsync100_n3` |
...
| Managed ProvChain runtime dir | `/home/cit/provchain-org/benchmark-toolkit/results/provchain-runtime/20260429_profile_ledger_supply1000_provchain-only_walsync100_n3` |
...
|---|---|---|---|
| `epoch-001` | `20260429T064232Z` | `passed` | ok |
| `epoch-002` | `20260429T064256Z` | `passed` | ok |
| `epoch-003` | `20260429T064322Z` | `passed` | ok |
